...
public class RecipeDAO {
    ...
    public long insert(Recipe recipe) {
        ...
        long newRecipeId = insert(recipe.getName(), recipe.getCategory(), recipe.getDescription(), recipe.getImagePath(),recipe.getPricee() );
        ...
        recipe.getIngredients()
                .forEach(ingredient -> {
                   ...
                   // Log.i("DAO", "Inserted new recipe : " + pricee);
    ...
    private long insert(String name, String category, String description, String imagePath , double pricee) {
        ...
        values.put(Config.KEY_PRICE,pricee);
    ...
    public List<Recipe> selectAllByCategory(String category) {
        ...
        try (Cursor cursor = db.query(Config.TABLE_NAME,
                new String[]{Config.KEY_ID, Config.KEY_NAME, Config.KEY_CATEGORY, Config.KEY_DESCRIPTION, Config.KEY_IMAGE_PATH , Config.KEY_PRICE} ,
