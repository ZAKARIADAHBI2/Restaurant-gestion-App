            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-4 my-4">
                        ...
                        <div className={style.Row}>
                            <a className={style.Link} href="https://www.facebook.com/zakaria.dahbi.3551" target="_blank" rel="noopener noreferrer">
                            ...
                            <a className={style.Link} href="https://www.instagram.com/zack.dh2/?hl=fr" target="_blank" rel="noopener noreferrer">
                ...
                <div className={`mb-2 ${style.Row}`}>
                    <span
                        ...
                        Copyright © {new Date().getFullYear()} zakaria dahbi 
                    </span>
                </div>
            </div>
        </footer>
